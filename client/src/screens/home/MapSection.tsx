...
const Map = () => {
	return (
		<section className='flex flex-col lg:flex-row shadow-fuchsia-950/20 shadow-lg rounded-lg overflow-hidden'>
			<div className='flex flex-col justify-center w-full lg:w-1/2 bg-gray-200 p-10 gap-1 pl-8 lg:pl-20'>
				...
				<p className='text-sm'>
					...
					<a
						...
						className='text-black/80 hover:text-primary'
					>
						thrill@gmail.com
					</a>
				</p>
			...
			<div className='w-full lg:w-1/2 relative h-96 lg:h-auto'>
